...
=== SUITE 1 (upload+download): 5/5 passed ===
  ...
  ✓ api_auth_and_create: PASS — HTTP 200 — tid=2180a237e360…
...
=== SUITE 2 (view modes): 4/4 passed ===
  ✓ api_upload: PASS — tid=e19be062a476…
...
All 6 live site routes responded HTTP 200. Access token was set (17 chars).
Routes checked: root, download entry, gallery, browse, viewer, invalid-hash (error-handling path).
