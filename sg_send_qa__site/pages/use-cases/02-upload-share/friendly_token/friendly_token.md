...
permalink: /pages/use-cases/friendly_token/
---
...
|--------|-------------|:-----------:|
| `friendly_token_upload_and_resolve` | Upload with Simple Token mode, then resolve the friendly token in a new tab. | 3 |
...
| `friendly_token_no_key_in_url_after_decrypt` | After decryption, the hash should be cleared from the URL. | 4 |
| `friendly_token_upload_and_resolve` | Upload with Simple Token mode, then resolve the friendly token in a new tab. | 5 |
| `friendly_token_format` | Verify the friendly token matches the word-word-NNNN pattern. | 3 |
| `friendly_token_resolves_in_new_tab` | Upload with Simple Token, then open the token in a new browser tab. | 4 |
...
Token: flash-berry-4187

![05 Token Captured](screenshots/05_token_captured.png)

### 06 Token Resolved

Token 'flash-berry-4187' resolved
...
Token: petal-stamp-4929

![05 Token Captured](screenshots/05_token_captured.png)

### 06 Token Resolved

Token 'petal-stamp-4929' resolved
...
URL after decrypt: http://localhost:10062/en-gb/browse/#guard-ivory-3826
...
**File:** `tests/qa/v030/test__friendly_token.py`
