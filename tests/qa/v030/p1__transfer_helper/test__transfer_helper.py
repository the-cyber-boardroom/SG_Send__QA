...
def _encrypt_raw(plaintext: bytes, filename: str):
    """Encrypt using the same AES-256-GCM + SGMETA envelope format as TransferHelper."""
...
class TestSGMETAEnvelope:
    ...
    def test_magic_prefix(self):
        ...
        ciphertext, _, _, _ = _encrypt_raw(b"hello", "test.txt")
    ...
    def test_magic_hidden_after_decryption_prefix(self):
        ...
        ciphertext, _, key_bytes, _ = _encrypt_raw(b"hello", "test.txt")
    ...
    def test_meta_length_field(self):
        ...
        ciphertext, _, key_bytes, _ = _encrypt_raw(b"content", filename)
    ...
    def test_filename_in_metadata(self):
        ...
        ciphertext, _, key_bytes, _ = _encrypt_raw(b"pdf content", filename)
    ...
    def test_content_after_metadata(self):
        ...
        ciphertext, _, key_bytes, _ = _encrypt_raw(plaintext, "test.txt")
...
class TestAESGCMParameters:
    ...
    def test_auth_tag_present(self):
        ...
        ciphertext, _, _, iv = _encrypt_raw(plaintext, "file.txt")
...
class TestRoundTrip:
    ...
    def test_plaintext_survives_round_trip(self):
        ...
        ciphertext, _, key_bytes, _ = _encrypt_raw(plaintext, "hello.txt")
    ...
    def test_empty_plaintext_round_trip(self):
        ...
        ciphertext, _, key_bytes, _ = _encrypt_raw(b"", "empty.txt")
    ...
    def test_binary_content_round_trip(self):
        ...
        ciphertext, _, key_bytes, _ = _encrypt_raw(content, "binary.bin")
    ...
    def test_unicode_filename_round_trip(self):
        ...
        ciphertext, _, key_bytes, _ = _encrypt_raw(b"text", filename)
...
class TestKeyEncoding:
    ...
    def test_key_is_base64url(self):
        ...
        _, key_b64, _, _ = _encrypt_raw(b"data", "f.txt")
    ...
    def test_key_uniqueness(self):
        ...
        keys = set()
        for _ in range(10):
            _, key_b64, _, _ = _encrypt_raw(b"same content", "same.txt")
            keys.add(key_b64)
...
class TestIVUniqueness:
    ...
    def test_iv_is_random_per_call(self):
        ...
        ivs = set()
        for _ in range(10):
            ciphertext, _, _, iv = _encrypt_raw(b"identical content", "same.txt")
            ivs.add(iv)
    ...
    def test_ciphertext_differs_due_to_iv(self):
        ...
        blobs = set()
        for _ in range(5):
            ciphertext, _, _, _ = _encrypt_raw(b"same text", "f.txt")
...
class TestWrongKeyFails:
    ...
    def test_wrong_key_raises(self):
        ...
        ciphertext, _, _, _ = _encrypt_raw(b"secret", "secret.txt")
    ...
    def test_wrong_iv_raises(self):
        ...
        ciphertext, _, key_bytes, _ = _encrypt_raw(b"secret", "secret.txt")
    ...
    def test_truncated_ciphertext_raises(self):
        ...
        ciphertext, _, key_bytes, _ = _encrypt_raw(b"secret data", "f.txt")
